...
def main():
    try:
        # URLs and table IDs for top 5 European leagues players
        url_standard_giocatori = "https://fbref.com/it/comp/Big5/stats/calciatori/Statistiche-di-I-5-campionati-europei-piu-importanti"
        table_id_standard = "stats_standard"

        url_misc_giocatori = "https://fbref.com/it/comp/Big5/misc/calciatori/Statistiche-di-I-5-campionati-europei-piu-importanti"
        ...
        url_tir_giocatori = "https://fbref.com/it/comp/Big5/shooting/calciatori/Statistiche-di-I-5-campionati-europei-piu-importanti"
        ...
        df_standard = fetch_table(url_standard_giocatori, table_id_standard)
        ...
        df_tir = fetch_misc_table(url_tir_giocatori, table_id_tir, columns_to_extract_tir, column_mapping_tir)

        # Validate 'Giocatore' column
        if 'Giocatore' not in df_tir.columns:
            raise KeyError("'Giocatore' non trovato in df_tir (Giocatori)")
        ...
        # Save to CSV
        df_total.to_csv("public/data/players/league_players.csv", index=False, encoding='utf-8')
        print("league_players.csv has been created successfully.")
