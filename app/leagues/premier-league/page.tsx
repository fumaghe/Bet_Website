...
export default function PremierLeaguePage() {
  ...
  const currentLeague = 'Premier League'; // Definisci la lega corrente
        ...
        <div className="container px-6">
          <div className="grid gap-8 grid-cols-1 lg:grid-cols-3">
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="p-6">
                <h2 className="text-xl font-bold mb-4">Tutte le Partite di Oggi</h2>
            ...
            <div className="space-y-6">
              <Card className="p-6">
                <h2 className="text-xl font-bold mb-4">Classifica Premier League</h2>
